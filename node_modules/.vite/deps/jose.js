...
var FlattenedEncrypt = class {
  ...
  async encrypt(key, options) {
    ...
    if (joseHeader.zip !== void 0 && !((_a3 = __privateGet(this, _protectedHeader)) == null ? void 0 : _a3.zip)) {
      throw new JWEInvalid('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
    }
    const { alg, enc } = joseHeader;
    if (typeof alg !== "string" || !alg) {
...
var GeneralEncrypt = class {
  ...
  async encrypt() {
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      if (joseHeader.zip !== void 0 && !((_a3 = __privateGet(this, _protectedHeader2)) == null ? void 0 : _a3.zip)) {
        throw new JWEInvalid('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
      }
    }
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      const alg = ((_b3 = recipient.unprotectedHeader) == null ? void 0 : _b3.alg) || ((_c = __privateGet(this, _protectedHeader2)) == null ? void 0 : _c.alg) || ((_d = __privateGet(this, _unprotectedHeader2)) == null ? void 0 : _d.alg);
